...
import Epitome from '../assets/Frame 5.png'
import MaterialImg1 from'../assets/Group 1.png'
import MaterialImg2 from'../assets/Frame 11.png'
import vector1 from'../assets/Vector 1.png'
import vector2 from'../assets/Vector 2.png'
import Curve from '../assets/3d-glassy-curved-line 2.png'
...
const HeroPage = () => {
  return (
    ...
    sm:mb-[0px]
     max-w-[1340px] 
    xl:w-[100vw]  relative font-lato h-[80vh] flex  justify-center mt-[0px] m-auto text-center overflow-hidden ' >
      ...
      <img src={MaterialImg2} alt="material" className='
       ...
       <div className="orderNow-btn absolute flex justify-around bottom-0 w-[130px] left-1/2 items-center ml-[-50px]">
        <p className='text-customBlue'>Order Now</p>
