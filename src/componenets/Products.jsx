...
const Products = () => {
  ...
  return (
    <div className=' max-w-[1340px] flex flex-col m-auto sm:mt-[5px] font-lato mb-[50px] pr-[30px] pl-[30px]'>
      ...
      <button className='text-customBlue hover:bg-customBlue w-[150px] mt-5 p-2 m-auto hover:text-white rounded-xl'>View all Products</button>
    </div>
  )
}
